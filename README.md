...
<script async="" src="./Digital Technology_files/app.js.download" charset="UTF-8" crossorigin="*"></script><script async="" src="./Digital Technology_files/default" charset="UTF-8" crossorigin="*"></script><script type="text/javascript">
var Tawk_API=Tawk_API||{}, Tawk_LoadStart=new Date();
(function(){
var s1=document.createElement("script"),s0=document.getElementsByTagName("script")[0];
s1.async=true;
s1.src='https://embed.tawk.to/5e945be535bcbb0c9ab07c75/default';
s1.charset='UTF-8';
...
<script type="text/javascript">
    ...
    <!-- Font Awesome JS -->
    <link rel="stylesheet" href="./Digital Technology_files/popup.css">

    <script src="./Digital Technology_files/news.js.download"></script>
    <script src="./Digital Technology_files/bootstrap.min.js.download"></script>
    <script src="./Digital Technology_files/jquery.min.js.download"></script>
    <script type="text/javascript">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
						...
						<canvas id="canvas" width="1366" height="568"></canvas>
                            <div>
                                <p>
                                    <img id="img" class="img-left" src="./Digital Technology_files/baner.png" style="width: 780px;margin-top: 0px;height: 255px;"></p>
        ...
        <div class="wrapper">
            ...
            <nav id="sidebar" class="mCustomScrollbar _mCS_1 mCS-autoHide mCS_no_scrollbar" style="overflow: visible;"><div id="mCSB_1" class="mCustomScrollBox mCS-minimal mCSB_vertical mCSB_outside" style="max-height: none;" tabindex="0"><div id="mCSB_1_container" class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="position:relative; top:0; left:0;" dir="ltr">
                <div class="sidebar-header">
                    <h3>
                        <img src="./Digital Technology_files/logo.png" class="mCS_img_loaded">
                    </h3>
                </div>
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
							...
							<li class="demo-click-new"><a href="https://moneypay.com/demo.aspx"><img src="./Digital Technology_files/aepsdemo.gif"></a></li>
...
<div class="carousel-item">
                                    <img class="d-block w-100" src="./Digital Technology_files/RAJNISH LOGO.png" alt="slider1 ">
                                </div>
                                 <div class="carousel-item">
                                    <img class="d-block w-100" src="./Digital Technology_files/KAJAL LOGO.png" alt=" slider2">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="./Digital Technology_files/RISHABH LOGO.png" alt="slider3 ">
                                </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="./Digital Technology_files/hoteltbookingbanner.jpg" alt=" slider4">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="./Digital Technology_files/slider1.png" alt="slider5 ">
                                </div>
                                <div class="carousel-item active">
                                    <img class="d-block w-100" src="./Digital Technology_files/slider2.png" alt="slider6">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="./Digital Technology_files/slider3.png" alt="slider8">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="./Digital Technology_files/slider4.png" alt=" slider9">
                                </div>
                            <div class="carousel-item">
                                    <img class="d-block w-100" src="./Digital Technology_files/PRITY LOGO.png" alt=" slider10">
                                </div>
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="services">
                            <i>
                                <img class="" src="./Digital Technology_files/rechargeicon.png">
                            </i>
                            <h3>All Recharge  </h3>
                    ...
                    <div class="col-sm-3">
                        <div class="services">
                            <i>
                                <img class="" src="./Digital Technology_files/moneytransfericon.png">
                            </i>
                    ...
                    <div class="col-sm-3">
                        <div class="services">
                            <i>
                                <img class="" src="./Digital Technology_files/aepsicon.png">
                            </i>
                            <h3>AEPS  </h3>
                            <div class="s_line"></div>
                    ...
                    <div class="col-sm-3">
                        <div class="services">
                            <i>
                                <img class="" src="./Digital Technology_files/bbpsicon.png">
                            </i>
                            <h3>BBPS   </h3>
                            <div class="s_line"></div>
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="services">
                            <i>
                                <img class="" src="./Digital Technology_files/creditcardbillpayicon.png">
                            </i>
                    ...
                    <div class="col-sm-3">
                        <div class="services">
                            <i>
                                <img class="" src="./Digital Technology_files/insurancebillpayicon.png">
                            </i>
                    ...
                    <div class="col-sm-3">
                        <div class="services">
                            <i>
                                <img class="" src="./Digital Technology_files/pancardicon.png">
                            </i>
                            <h3>Pan Card   </h3>
                            <div class="s_line"></div>
                    ...
                    <div class="col-sm-3">
                        <div class="services">
                            <i>
                                <img class="" src="./Digital Technology_files/indonepalmoneytransfericon.png">
                            </i>
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="services">
                            <i>
                                <img class="" src="./Digital Technology_files/hathwaytvicon.png">
                            </i>
                    ...
                    <div class="col-sm-3">
                        <div class="services">
                            <i>
                                <img class="" src="./Digital Technology_files/loanicon.png">
                            </i>
                            <h3>Loan   </h3>
                            <div class="s_line"></div>
                    ...
                    <div class="col-sm-3">
                        <div class="services">
                            <i>
                                <img class="" src="./Digital Technology_files/accountopeningicon.png">
                            </i>
                    ...
                    <div class="col-sm-3">
                        <div class="services">
                            <i>
                                <img class="" src="./Digital Technology_files/aadhaardownload.png">
                            </i>
                            ...
                            <div class=" col-sm-4 col-md  col-6 col">
                                ...
                                <ul class="footer_ul_amrc">
                                    <li><a href=""><i class="" style="background-color: #0a52ce; padding: 4px 1px 5px 8px; border-radius: 57%;">
                                        <img src="./Digital Technology_files/facebookicon.png">
                                    </i>&nbsp; Facebook  </a></li>
                                    <li><a href=""><i class=" " style="background-color: #0a52ce; padding: 4px 1px 5px 8px; border-radius: 57%;">
                                        <img src="./Digital Technology_files/twittericon.png">
                                    </i>&nbsp;  Twitter  </a></li>
                                    <li><a href=""><i class=" " style="background-color: #0a52ce; padding: 4px 1px 5px 8px; border-radius: 57%;">
                                        <img src="./Digital Technology_files/googleplusicon.png">
                                    </i>&nbsp; Google Plus </a></li>
                                    <li><a href=""><i class=" " style="background-color: #0a52ce; padding: 4px 1px 5px 8px; border-radius: 57%;">
                                        <img src="./Digital Technology_files/linkedinicon.png">
                                    </i>&nbsp; Linked In </a></li>
                                </ul>
                                <!--footer_ul_amrc ends here-->
                            </div>
        ...
        <script src="./Digital Technology_files/jquery-3.3.1.slim.min.js.download"></script>
        <!-- Popper.JS -->
        <!-- Bootstrap JS -->
        <script src="./Digital Technology_files/bootstrap.min.js.download"></script>
        <!-- jQuery Custom Scroller CDN -->
        <script src="./Digital Technology_files/jquery.mCustomScrollbar.concat.min.js.download"></script>
		...
		<script src="./Digital Technology_files/script.js.download"></script>
    </form>
